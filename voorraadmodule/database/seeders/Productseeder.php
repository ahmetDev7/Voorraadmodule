...
class Productseeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $product3 = Product::create(['productnummer' => '003', 'name' => 'test03', 'description' => 'testproduct3', 'category' => 'test']);
        $product4 = Product::create(['productnummer' => '004', 'name' => 'test04', 'description' => 'testproduct4', 'category' => 'test']);
        $product1->save();
        $product2->save();
        $product3->save();
        $product4->save();
