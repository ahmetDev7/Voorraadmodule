@extends('layouts.master') @section('content') <div class="serienummers-pagina">
  <h1>Serienummers</h1> <a href="/serienummers/toevoegen" class="add-button">
    <p>Serienummer toevoegen</p>
  </a> <!-- Adding a bit of space -->
  ...
  <div class="bg-white pb-4 px-4 rounded-md w-full" style="width:1000px; margin-left:auto; margin-right:auto; margin-top:50px;">
    <div class="w-full flex justify-end px-2 mt-2">
      <div class="w-full sm:w-64 inline-block relative ">
        <form action="{{ route('products.search') }}" method="GET"> <input type="search" name="search" value="{{ request('search') }}" class="leading-snug border border-gray-300 block w-full appearance-none bg-gray-100 text-sm text-gray-600 py-1 px-4 pl-8 rounded-lg" placeholder="Zoeken" /> </form>
        <div class="pointer-events-none absolute pl-3 inset-y-0 left-0 flex items-center px-2 text-gray-300"> <svg class="fill-current h-3 w-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 511.999 511.999">
    ...
    <div class="overflow-x-auto mt-6">
      <table class="table-auto border-collapse w-full">
        ...
        <tbody class="text-sm font-normal text-gray-700"> @forelse($serienummers as $s) <tr class="hover:bg-gray-100 border-b border-gray-200 py-10">
