      ...
      <table class="table-auto border-collapse w-full">
        ...
        <tbody class="text-sm font-normal text-gray-700">
          ...
          <td class="px-4 py-4">
            ...
            <a href="{{ route('warehouses.edit', $w->id) }}" class="small-button" background-color=red>
              <img id="logo" src="{{url('/images/edit-icon.png')}}">
            </a>
            <a href="{{ route('warehouses.delete', $w->id) }}" class="small-add-button"
              style="background-color: red; justify-content: center; align-items: center; width: 50px;border-radius: 5px; height: 1xp;"
              onclick="confirmation(event,' deze warehouse en zijn producten worden verwijderd ga jij hiermee akkoord?')">
              <p>Delete</p>
            </a>
        </div>
        </a>
